...
export function DashboardPage() {
  ...
  useEffect(() => {
    ...
    if (
      ...
      setErrorMessage(
        "Por favor configura tus credenciales de Supabase en el archivo .env",
      );
      return;
    }
    ...
    resolveActiveDevice()
      .then((id) => {
        if (id) {
          ...
          setConnectionStatus("error");
          setErrorMessage(
            "No se encontró ningún dispositivo activo en la base de datos",
          );
        }
      })
      .catch((error) => {
        ...
        setConnectionStatus("error");
        setErrorMessage(
          "Error al conectar con Supabase. Verifica tus credenciales.",
        );
      });
  }, []);
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-red-400 text-xs mt-2">
                  Asegúrate de configurar VITE_SUPABASE_ANON_KEY en tu archivo
                  .env
                </p>
              </div>
            </div>
            ...
            {todaysEvents && todaysEvents.length > 0 ? (
              ...
              <div className="text-center py-8 text-gray-400">
                ...
                <div className="text-sm">
                  Registra tu primer evento para comenzar
                </div>
              </div>
            )}
          </div>
